...
hl_groups = {
    ...
    ["MiniIconsCyan"] = { fg = cyan, bg = c.no, extras = {} },
    ["MiniIconsGreen"] = { fg = green, bg = c.no, extras = {} },
    ["MiniIconsGrey"] = { fg = grey, bg = c.no, extras = {} },
    ["MiniIconsOrange"] = { fg = orange, bg = c.no, extras = {} },
    ["MiniIconsPurple"] = { fg = purple, bg = c.no, extras = {} },
    ...
    ["RainbowDelimiterOrange"] = { fg = orange, bg = c.no, extras = {} },
    ["RainbowDelimiterGreen"] = { fg = green, bg = c.no, extras = {} },
    ["RainbowDelimiterViolet"] = { fg = violet, bg = c.no, extras = {} },
    ["RainbowDelimiterCyan"] = { fg = cyan, bg = c.no, extras = {} },
    ...
    ["Todo"] = "TodoComment",
    ["Delimiter"] = { fg = white, bg = c.no, extras = {} },
